...
<!--- /footer-btm ---->
<!--- banner-1 ---->
<div class="banner-1" style="background-image:url('./images/interior.jpg');">
	<div class="container">
...
<div class="bus-btm">
	<div class="container" style="padding: center">
		<ul>
			...
			<li class="kursi"><a href="#">Kapasitas</a></li>
...
<div class="copy-right">
	<div class="container">
		...
		<p class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;">© 2018 . All Rights Reserved | Design by JRC </p>
	</div>
</div>
<!--- /copy-right ---->
<!-- sign -->
