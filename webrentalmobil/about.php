...
<!--- /footer-btm ---->
<!--- banner-1 ---->
<div class="banner-1" style="background-image:url('./img/15.png');">
	<div class="container">
...
<div class="about">
	<div class="container">
		<div class="about-top wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;">
			...
			<p>Rental Mobil ini merupakan salah satu penyedia layanan rental mobil di Jember. Menggunakan armada mobil keluaran baru, dengan kondisi terawat untuk disewakan kepada Anda. Dengan pilihan mobil yang kami sediakan sangat variatif dan harga yang sangat kompetitif di Jember.  Kami menawarkan untuk Anda seperti: rental alphard, Toyota Innova, Daihatsu Xenia, Avanza, Suzuki APV, Nissan, Grand Livina, Luxio. Anda dapat menyewa untuk harian maupun bulanan.</p>
		</div>
		<div class="about-mid">
			...
			<div class="col-md-6 abt-lft wow fadeInRight animated" data-wow-delay=".5s">
				<h3>Visi</h3>
				<p>Menjadi perusahaan transportasi ataupun rekan kerja yang menyediakan jasa penyewaan mobil yang dapat diandalkan. Kami berupaya untuk menempatkan diri sebagai perusahaan rental mobil terdepan di kawasan tapal kuda khususnya Jember.</p>
				</div>
			<div class="clearfix"></div>
		</div>
		<div class="about-top wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;">
