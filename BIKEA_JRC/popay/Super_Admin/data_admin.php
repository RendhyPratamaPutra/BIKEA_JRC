    ...
    if (!isset($_SESSION['admin']) ) {
     ...
     if ( isset($_POST["update"])) {
        ...
        if (ubahadmin($_POST) > 0){
           echo "<script> alert('Data Berhasil Berubah.'); location = 'data_admin.php'; </script>";
    }else {
      echo "<script> alert('Maaf Data Gagal Dirubah !!'); location = 'data_admin.php'; </script>";
       }
  }
                     ...
                     <br>                        <h3>DATA ADMIN</h3><hr>
                        ...
                        <form class="form-horizontal" method="post" action="">
                                    ...
                                    while ($row = mysqli_fetch_array($result)) {  
                                        ...
                                        $jsArray .= "prdName['" . $row['nip'] . "'] = {name:'" . addslashes($row['nama_admin']) . "',tempat:'".addslashes($row['tempat_lahir'])."',tanggal:'".addslashes($row['tanggal_lahir'])."',jenis:'".addslashes($row['jenis_kelamin'])."',almat:'".addslashes($row['alamat'])."'status:'".addslashes($row['statuspassword'])."'};\n";    
                                    }  
                                    echo '</select>';  
                                    ?>  
                                 <tr>
                                  <br/><br />Nama Admin : <input type="text" name="nama_admin" id="prd_name"/>
