<?php
    ...
    if ( isset($_POST["register"])) {
        ...
        if (register($_POST) > 0){
           echo "<script> alert('Selamat Input Berhasil.'); location = 'input_admin.php'; </script>";
    }else {
      echo "<script> alert('Maaf Data Gagal Disimpan !!'); location = 'input_admin.php'; </script>";
       }
  }
                ...
                <div class="row ">
                    <div class="col-sm-6 ">
                     <br><br><br>
                        ...
                        <form class="form-horizontal" method="post" action="">
                             <div class="form-group">
                                  <label for="" class="col-sm-3 control-label">NIP</label>
                                   <div class="col-sm-9">
                                    <input class="form-control" name="nip" placeholder="NIP" type="text" required>
                                </div>
                            </div>
                            <div class="form-group">
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-control" name="nama_admin" placeholder="Nama Admin" type="text" required>
                                </div>
                            </div>
                             <div class="form-group">
                                <label for="" class="col-sm-9 col-sm-offset-3">Tempat Lahir</label>
                                <div class="col-sm-9">
                                    <input class="form-control" name="tempat_lahir" placeholder="Tempat Lahir" type="text" required>
                                </div>
                            </div>
                          </div>
                           <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-control"  name="tanggal_lahir" placeholder="yyyy/mm/dd" type="date" required>
                                </div>
                            </div>
                              <div class="form-group">
                            ...
                            <?php
                             $sql = mysqli_query($koneksi,"SELECT * FROM grup ORDER BY grup ASC"); 
                            ?>
                           <div class="form-group">
                        ...
                        <div class="form-group">
                                <label for="" class="col-sm-9 col-sm-offset-3">Status</label>
                            <div class="col-sm-9">
                            <select name="kd_grup">
                                <?php if (mysqli_num_rows($sql) > 0 ) { ?>
                                    <?php while ($row = mysqli_fetch_array($sql)) { ?>
                                    <option value="<?php echo $row['kd_grup']  ?>"> <?php echo $row['grup']  ?> </option>
                                <?php } ?>
                                  <?php } ?>
                            </select>
                           </div>
